...
export const LoginPage = () => {
    ...
    const { registerNombre, registerEmail, registerPassword, registerPasswordConfirmation, onInputChange: onInputRegisterChange, onResetForm } = useForm(registerInitialValue);
    ...
    const onRegister = (e) => {
        ...
        startRegister({nombre: registerNombre, correo: registerEmail, contrasena: registerPassword})
    };
