...
export const MostrarResultados = () => {
    ...
    const { startLoadResults, startDeleteResult, cargandoResultado } = useResultadoStore();
                                    ...
                                    <div className="card shadow-lg border-0 rounded-4 p-4">
                                        ...
                                        <div className="card-body text-center">
                                            ...
                                            <div className="mt-3 d-flex justify-content-center flex-wrap gap-2">
                                                ...
                                                <Link to={`/admin/resultados/actualizar/${resultado.id}`} className="btn btn-primary btn-sm text-white">
                                                    Actualizar
                                                </Link>
                                                <button 
